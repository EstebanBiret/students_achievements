...
/**
 * This file is responsible for producing the downloadable versions of student achievements
 *
...
//get the ids from the GLOBAL variables (set in ajax files)
global $SESSION;
...
foreach ($sequences as $sequence) {
        ...
        //browse each type of modues in this course
...
//get student's infomations for the file name
$user = $DB->get_record('user', ['id' => $studentId]);

//download file
\core\dataformat::download_data($user->firstname . '_' . $user->lastname . '_' . $date_extraction, $dataformat, $columns, $data); // moodle/lib/classes/dataformat.php
